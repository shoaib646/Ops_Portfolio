...
from networksecurity.constant.variables import DATA_TRANSFORMATION_IMPUTER_PARAMS
...
class DataTransformation:
    def __init__(self, LastArtifact: DataValidationArtifact,
        ...
        """
        try:
            self.data_validation_artifact: DataValidationArtifact = LastArtifact
